		...
		<div class="flex-w p-b-90">
			<div class="w-size6 p-t-30 p-l-15 p-r-15 respon3">
				...
				<div>
					...
					Any questions? Let us know in our Mail </p>
			...
			<div class="t-center s-text8 p-t-20" style="color:black;">
				Copyright © 2018 All rights reserved. | This template is made by PSCMRCET	</div>
		</div>
	</footer>
