		...
		<div class="container-menu-header">
			...
			<div class="wrap_header">
				...
				<a href="index.html" class="logo">
					<img   src="./assets1/images/icons/logo.png" alt="IMG-LOGO">
				</a>
			...
			<nav class="menu">
				...
				<div class="header-icons">
					...
					<div class="header-wrapicon2">
						<img  src="./assets1/images/icons/icon-header-02.png" class="header-icon1 js-show-header-dropdown" alt="ICON">
					...
					<div class="p-r-50 p-r-0-lg">
						...
						<div class="item-blog p-b-80">
							<a href="blog-detail.html" class="item-blog-img pos-relative dis-block hov-img-zoom">
								<img  src="./assets1/images/blog-04.jpg" alt="IMG-BLOG">
						...
						<div class="item-blog p-b-80">
							<a href="blog-detail.html" class="item-blog-img pos-relative dis-block hov-img-zoom">
								<img  src="./assets1/images/blog-05.jpg" alt="IMG-BLOG">
						...
						<div class="item-blog p-b-80">
							<a href="blog-detail.html" class="item-blog-img pos-relative dis-block hov-img-zoom">
								<img  src="./assets1/images/blog-08.jpg" alt="IMG-BLOG">
						...
						<div class="item-blog p-b-80">
							<a href="blog-detail.html" class="item-blog-img pos-relative dis-block hov-img-zoom">
								<img  src="./assets1/images/blog-02.jpg" alt="IMG-BLOG">
						...
						<div class="item-blog p-b-80">
							<a href="blog-detail.html" class="item-blog-img pos-relative dis-block hov-img-zoom">
								<img  src="./assets1/images/blog-03.jpg" alt="IMG-BLOG">
						...
						<ul class="bgwhite">
							<li class="flex-w p-b-20">
								<a href="product-detail.html" class="dis-block wrap-pic-w w-size22 m-r-20 trans-0-4 hov4">
									<img  src="./assets1/images/item-16.jpg" alt="IMG-PRODUCT">
								</a>
							...
							<li class="flex-w p-b-20">
								<a href="product-detail.html" class="dis-block wrap-pic-w w-size22 m-r-20 trans-0-4 hov4">
									<img  src="./assets1/images/item-17.jpg" alt="IMG-PRODUCT">
								</a>
							...
							<li class="flex-w p-b-20">
								<a href="product-detail.html" class="dis-block wrap-pic-w w-size22 m-r-20 trans-0-4 hov4">
									<img  src="./assets1/images/item-08.jpg" alt="IMG-PRODUCT">
								</a>
							...
							<li class="flex-w p-b-20">
								<a href="product-detail.html" class="dis-block wrap-pic-w w-size22 m-r-20 trans-0-4 hov4">
									<img  src="./assets1/images/item-03.jpg" alt="IMG-PRODUCT">
								</a>
							...
							<li class="flex-w p-b-20">
								<a href="product-detail.html" class="dis-block wrap-pic-w w-size22 m-r-20 trans-0-4 hov4">
									<img  src="./assets1/images/item-05.jpg" alt="IMG-PRODUCT">
								</a>
