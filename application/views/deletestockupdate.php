...
<form action="./deletestockupdate?token='.<?php echo  base64_encode(base64_encode(base64_encode($product->id))); ?>.'" method="POST" enctype="multipart/form-data">
  <div class="container">
...
<label for="category"><b>  QUANTITY :</b></label> &nbsp &nbsp  &nbsp  &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp
        <input type="number" placeholder="ENTER THE QUANTITY OF THE PRODUCTS" max="<?php echo $product->quantity; ?>" name="quantity"  required ><br> <BR>
