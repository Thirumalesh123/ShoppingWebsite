...
<h1 align="center" style="color:;">SLIDER  UPLOAD FORM</h1><br>
<div class="container" style="width:60%;">
    ...
    <input type="text" placeholder="ENTER THE TYPE OF THE PRODUCTS" name="link" style="text-transform:uppercase;" required><br> <br>
    ...
    <label for="quotation"><b>QUOTQTION ON THE IMAGE:</b></label><BR>
        <input type="text" placeholder="ENTER  QUOTQTION ON THE IMAGE" name="quotation" value=""  >  
