...
{
?>
<form action="./blocklist_edit?token='.<?php echo  base64_encode(base64_encode(base64_encode($slider->id))); ?>.'" method="POST" enctype="multipart/form-data">

<h1 align="center" style="color:;">BLOCK EDIT FORM</h1><br>
<div class="container" style="width:60%;">
       
    <label for="title"><b>NAME OF THE SLIDER </b></label><br>
       <input type="text" placeholder="ENTER NAME OF THE SLIDER" name="name" value="<?php echo $slider->block_name;?>"required><br> <br>
