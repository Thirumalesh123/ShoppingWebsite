	...
	<footer class="bg6 p-t-45 p-b-43 p-l-45 p-r-45">
		<div class="flex-w p-b-90">
			...
			<div class="w-size7 p-t-30 p-l-15 p-r-15 respon4">
				...
				<ul>
				<li class="p-b-9">
						<a href="${contextRoot}/index" class="s-text7">
							Home
						</a>
					</li>
					<li class="p-b-9">
						<a href="${contextRoot}/men" class="s-text7">
							Men
						</a>
					</li>

					<li class="p-b-9">
						<a href="${contextRoot}/women" class="s-text7">
							Women
						</a>
					</li>

					<li class="p-b-9">
						<a href="${contextRoot}/children" class="s-text7">
							Children
						</a>
					</li>
			...
			<div class="w-size7 p-t-30 p-l-15 p-r-15 respon4">
				...
				<ul>
					...
					<li class="p-b-9">
						<a href="${contextRoot}/about" class="s-text7">
							About Us
						</a>
					</li>
					...
					<li class="p-b-9">
						<a href="${contextRoot}/contact" class="s-text7">
							Returns
						</a>
					</li>
				</ul>
			...
			<div class="w-size8 p-t-30 p-l-15 p-r-15 respon3">
				...
				<form>
					<div class="effect1 w-size9">
						<input class="s-text7 bg6 w-full p-b-5" type="text" name="email" placeholder="shopping@gmail.com">
		...
		<div class="t-center p-l-15 p-r-15">
			...
			<div class="t-center s-text8 p-t-20">
				Copyright © 2021 All rights reserved. | This template is made by G-SHOPPING 
			</div>
		</div>
	</footer>
