...
<div class="container  ">
    ...
    <div class="p-3 card-2">
        ...
        <div class="col-md-4"> <span>Payment Method</span>
            <div class="card">
        ...
        <div class="col-md-4"> <span>Summary</span>
            <div class="card">
                ...
                <div class="p-3 d-flex justify-content-between">
                    <div class="d-flex flex-column"> <span>Total you pay</span>  </div> <span>&#8377 ${userModel.cart.grandTotal}</span>
                </div>
                <div class="p-3"> <button class="btn btn-primary btn-block free-button">Proceed to Pay</button>
