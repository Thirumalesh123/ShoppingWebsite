...
public class SliderFileUtility {
	 private static final String ABS_PATH="C:\\Users\\Tirumalesh\\FinalProject\\Geminishopping\\src\\main\\webapp\\resources\\images\\slider\\";
	  private static String REAL_PATH=null;
	  public static boolean uploadFile(HttpServletRequest request,MultipartFile file,String image_url)
	  {
		  REAL_PATH=request.getSession().getServletContext().getRealPath("/resources/images/slider");
